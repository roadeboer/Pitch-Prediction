#Source https://billpetti.github.io/2018-02-19-build-statcast-database-rstats/
#Source https://collinerickson.github.io/2019/05/13/getting-better-mlb-data-from-baseballsavant-in-r/
#Source https://github.com/zetvzb/SABR/blob/master/Savant%20Data.R
#Modified to retrieve 2008-2019 MLB season data
.libPaths("C:/R")
...
saveRDS(x2008data, "MLBx2008.rds")
saveRDS(x2009data, "MLBx2009.rds")
saveRDS(x2010data, "MLBx2010.rds")
saveRDS(x2011data, "MLBx2011.rds")
saveRDS(x2012data, "MLBx2012.rds")
saveRDS(x2013data, "MLBx2013.rds")
saveRDS(x2014data, "MLBx2014.rds")
saveRDS(x2015data, "MLBx2015.rds")
saveRDS(x2016data, "MLBx2016.rds")
saveRDS(x2017data, "MLBx2017.rds")
saveRDS(x2018data, "MLBx2018.rds")
saveRDS(x2019data, "MLBx2019.rds")
